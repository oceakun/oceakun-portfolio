...
export default function ProjectPage() {
  return (
    <section>
      <h1 className="font-bold text-3xl dark:text-neutral-200 font-serif">Projects</h1>
      <div className="prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-200 ">
        <fieldset>
            ...
            <span className='mb-2'>
                <StackIcon/>
                <span className='italic text-sm dark:text-neutral-400 '> &nbsp; Astro, React-components,  Js, Grafana, Go, Firebase Auth, Firestore, Docker</span>
            </span>

            <span className='mb-5'>
                <HashIcon/>
                <span className='italic text-sm dark:text-neutral-400 '> &nbsp; full stack, visualization, authentication, API, containerization</span>
            </span>
            
            <span>visualize csv-exports through grafana panels, in the form of highly interactive tables and charts</span>
        ...
        <fieldset>
            ...
            <span className='mb-2'>
                <StackIcon/>
                <span className='italic text-sm dark:text-neutral-400'> &nbsp; Typescript-React, Context API, Styled Components  </span>
            </span>
        ...
        <fieldset>
            ...
            <span  className='mb-2'>
                <StackIcon/>
                <span className='italic text-sm dark:text-neutral-400'> &nbsp; Js, d3, HTMl, CSS</span>
            </span>

            <span className='mb-5'>
                <HashIcon/>
                <span className='italic text-sm dark:text-neutral-400'> &nbsp; visualization, responsive</span>
            </span>
