    ...
    <section>
      ...
      <div className='prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-200'>
        ...
        <fieldset>
          ...
          <p>
            As an intern at IIT Delhi, my daily deliverables are mostly related
            to developing frontend components by refering to their Figma design
            and documentating their functionality after I'm done.
          </p>
          <p>
          ...
          <p className='mb-8'>
            ...
            small projects, to make my knowledge of the same, concrete.
          </p>
        </fieldset>
