      ...
      <div className='prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-300 mt-12 text-justify'>
        <div className='text-justify'>
          <p className='w-full flex flex-row justify-between items-end'>
            ...
            <Link
              href='/blog'
              className='dark:text-amber-300 text-rose-500 hover:cursor-pointer no-underline font-[300]'
            >
              {/* <LeftArrowIcon /> */}
              <span>Back</span>
            </Link>
          ...
          <br />
          <p className="text-center bg-gradient-to-r from-rose-500 to-pink-900 dark:from-white dark:to-amber-900 inline-block text-transparent bg-clip-text flex flex-row justify-center items-center font-['']">
            Coming soon..
          </p>
        </div>
      </div>
