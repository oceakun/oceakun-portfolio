  ...
  return (
    <div className='w-full'>
      ...
      <p className='w-full flex flex-row justify-between items-center mt-12'>
        ...
        {/* <Link
          href='/blog'
          className='group dark:text-amber-300 text-amber-950 hover:cursor-pointer no-underline font-[300] inline-flex items-center justify-center transition-all duration-300 relative px-3 py-1.5 rounded-md shadow-[0_2px_8px_rgba(244,63,94,0.3)] hover:shadow-[0_4px_20px_rgba(244,63,94,0.6)] dark:shadow-[0_2px_8px_rgba(254,240,138,0.3)] dark:hover:shadow-[0_4px_20px_rgba(254,240,138,0.6)]'
        >
